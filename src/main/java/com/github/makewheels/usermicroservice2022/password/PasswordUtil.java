...
import com.github.makewheels.usermicroservice2022.UserMicroService2022Application;
...
public class PasswordUtil {
    ...
    private static String getPrivateKey(String env) {
        String path = null;
        if (env.equals("dev")) {
            path = "D:/workSpace/~keys/user-micro-service-2022/privateKey.txt";
        } else if (env.equals("prod")) {
            path = "/root/keys/user-micro-service-2022/privateKey.txt";
        }
    ...
    private static InputStream getPasswordFileInputStream(String env) {
        ...
        return UserMicroService2022Application.class.getResourceAsStream("/" + path);
    }
